...
$start = "http://localhost/wordpress/wp-admin/setup-config.php?step=1";
...
//NOTE:
//goto your xampp panel and click on shell then run the page    php index.php
//     name of website > pages.json     to get all the crawls in a json file
// just add [ at the front and ] and the ending link to get the parsed json or better still download a json viewer chrome extension , then reload pages.json on the browser.
